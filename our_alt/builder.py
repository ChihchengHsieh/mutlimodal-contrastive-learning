...
class OurApproachAlt(nn.Module):
    def __init__(
        self,
        base_encoder,
        clinical_input_dim,
        ...
        super(OurApproachAlt, self).__init__()
        ...
        self.img_loss = SimCLRLoss()
        self.tab_loss = SimCLRLoss()
        self.auto_loss = AutoEncoderLoss(n_cat_features)

        self.ci, self.ct, self.cit, self.cauto = ci, ct, cit, cauto
    ...
    def forward(self, img, tab):
        ...
        zt1, zt2, zt3, zt4 = (
            self.tab_pj(ht1),
            self.tab_pj(ht2),
            self.cross_tab_pj(ht3),
            self.cross_tab_pj(ht4),
        )

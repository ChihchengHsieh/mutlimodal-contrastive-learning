...
from torchvision.models.detection.faster_rcnn import FasterRCNN_ResNet50_FPN_Weights, _resnet_fpn_extractor, FastRCNNPredictor, TwoMLPHead
            ...
            if targets is None:
                ...
                for target in targets:
                    ...
                    if isinstance(boxes, torch.Tensor):
                        ...
                        torch._assert(
                            False, f"Expected target boxes to be of type Tensor, got {type(boxes)}.")
...
def fasterrcnn_resnet50_fpn(
    ...
    **kwargs: Any,
    ...
    backbone = resnet50(weights=weights_backbone,
                        progress=progress, norm_layer=norm_layer)
